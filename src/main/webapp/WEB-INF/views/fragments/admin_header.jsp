            ...
            <div class="nav-wrapper">
                <h1 class="logo-wrapper">
                    <a href="${digify}/admin/dashboard" class="brand-logo darken-1"><img alt="abatar"
                                                                                         src="${digify}/static/images/logo-512.png">
                    </a>
                </h1>
                ...
                <ul class="side-nav" id="mobile-demo">
                    <security:authorize access="hasRole('ROLE_ADMIN')">
                        ...
                        <li class="bold ${active eq 'products'? 'active':'' }"><a href="${digify}/admin/product"
                                ...
                                class="mdi-maps-local-offer"></i> Services </a></li>
                        <li class="bold ${active eq 'services'? 'active':'' }"><a href="${digify}/services"
                                                                                  class="waves-effect waves-cyan"><i
                                class="mdi-maps-local-offer"></i>Products</a></li>
                                   <li class="bold ${active eq 'allorders'? 'active':'' }"><a href="${digify}/admin/allOrders"
                                                                              class="waves-effect waves-cyan"><i
                            class="mdi-editor-format-list-bulleted"></i>All Orders</a></li>
                    </security:authorize>
                    <security:authorize access="isAuthenticated()">
                    ...
                    <div class="row">
                        <div class="col col s8 m8 l8">
                            <a class="btn-flat dropdown-button waves-effect waves-light white-text profile-btn" href="#"
                               data-activates="profile-dropdown">${user.name }<i
                ...
                <security:authorize access="hasRole('ROLE_ADMIN')">
                    ...
                    <li class="no-padding">
                        <ul class="collapsible collapsible-accordion">
                            <li class="bold ${contains eq 'yes' ? 'active':'' }"><a
                                ...
                                <div class="collapsible-body" style="">
                                    <ul>
                                        <c:forEach var="item" items="${listHomePgcontMaster }">
                                            <li class="bold ${active eq item.name ? 'active':'' }"><a
                                                    href="${digify}/admin/home/${item.name}/${item.viewFolder}/${item.id}"><i
                                                    class="${item.icon}"></i>${item.displayName}</a>
                                            </li>
                                        </c:forEach>
                                    </ul>
                                </div>

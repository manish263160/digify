...
<body class="${themecolor }">
	...
	<div class="container">
		...
		<div class="section">
			<p class="caption">All aboutus Images that uploaded by
				${user.name }</p>
			<div class="row">
				<p class="col s3">
					<a href="${digify}/admin/add/addHomeContentView/${id}/${viewsFolder}"
						...
						data-position="bottom" data-delay="50" data-tooltip="Upload aboutus">
						<i class="mdi-content-add ">Upload aboutus Image</i>
					</a>
				</p>
			</div>
			<!-- Modal Structure -->
			<div id="deleteAllCarausel" class="modal card pink lighten-5">
				<div class="modal-content ">
					...
					<p>Your all aboutus from data will be deleted permanently, and
						can't be undone.</p>
					...
					<div class="row warningmodel">
						...
						<c:if test="${not empty imagepath }">
							<img src="${imagepath }" alt="sample">
								...
								<div class="card-content">
									<p>There is no aboutus.Please click upload button to upload
										image.</p>
								</div>

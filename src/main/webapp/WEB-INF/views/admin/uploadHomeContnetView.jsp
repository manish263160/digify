    ...
    <form action="${digify}/admin/insertHomeContent?${_csrf.parameterName}=${_csrf.token}" method="post"
        ...
        <div class="row section">
            ...
            <div class="input-field col s8 m4 l7">
                <textarea id="contentDescription" type="text" class="materialize-textarea" maxlength="2000"
                          autocomplete="off" name="contentDescription"></textarea>

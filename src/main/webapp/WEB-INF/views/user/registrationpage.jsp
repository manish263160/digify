...
<div id="registration-form">
    <div id="login-page" class="row">
        <form:form action="${digify}/insertUser" class="login-form col s12 z-depth-4 card-panel" id="userRegForm"
            ...
            <div class="row">
                ...
                <div class="input-field col s12">
                    <p class="margin center medium-small sign-up">Already have an account? <a href="${digify}/login">Login</a>
                    </p>
                </div>
            </div>
        </form:form>

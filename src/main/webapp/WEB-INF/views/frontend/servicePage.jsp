...
<div class="container product-page">
    ...
    <div class="row">
        <div class="float-right offset-4 ">
            ...
            <c:choose>
                <c:when test="${service.isForEcommerce eq 1}">
                    <c:if test="${not empty loggedInUser}">
                        <button class="btn btn-primary" style="width: 100%;"
                                onclick="addTocart('${digify }','${loggedInUserId}','${service.id}','services');">Add To
                            Cart
                        </button>
                    </c:if>
                    <c:if test="${empty loggedInUser}">
                        <button class="btn btn-primary" style="width: 100%;" onclick="${digify}/login">Add To Cart
                        </button>
                    </c:if>

                </c:when>
                <c:otherwise>
                    <button class="btn btn-primary" style="width: 100%;" onclick="openModel('${service}','$event')">Get
                        Quotes
                    </button>
                </c:otherwise>
            </c:choose>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="quotes_form" action="#">
                        ...
                        <div class="form-group">
                            <input type="number" placeholder="Telephone" class="form-control1" id="mobile"
                                   name="mobile">
                        </div>
                        <div class="form-group">
                        ...
                        <input type="hidden" name="inquiryForId" value="${service.id }"> <input type="hidden"
                                                                                                name="inquiryFor"
                                                                                                value="${table}">

            ...
            <form action="${loginUrl}" method="post" class="login-form" id="formValidate">
                <div class="row">
                    <div class="input-field col s12 center">
                        <img src="${digify}/static/frontEnd/img/logo.png" alt="" class="valign profile-image-login">
                ...
                <div class="row">
                    ...
                    <div class="input-field col s6 m6 l6">
                        <p class="margin right-align medium-small"><a class="tooltipped modal-trigger" href="#modal1"
                                                                      data-position="bottom" data-delay="50"
                                                                      data-tooltip="Forgot Password">Forgot password
                            ?</a></p>
                    </div>
                </div>

...
<div class="container">
    ...
    <div class="section">
        <p class="caption">
            All ${tableName eq 'products' ? 'services' : tableName eq 'services' ? 'products' : tableName} Images that
            uploaded by ${user.name }</p>
        <div class="row">
            <p class="col s3">
                <a href="${digify}/admin/product/add/addProductView/${tableName}"
                   ...
                   data-delay="50" data-tooltip="Upload product"> <i
                        class="mdi-content-add ">Upload ${ tableName eq 'products' ? 'services' : tableName eq 'services' ? 'products' : tableName}
                    Image</i>
                </a>
            </p>
        </div>
        ...
        <div id="deleteAllCarausel" class="modal card pink lighten-5">
            ...
            <div class="modal-fixed-footer card-action pink lighten-4">
                <a href="#" class="waves-effect waves-red btn-flat modal-action modal-close pink-text">Disagree</a> <a
                    href="#"
                        ...
                        <div class="col s6 m3 l3 main-card">
                            <div class="card ">
                                ...
                                <div class="card-action">
                                    <a href="${digify}/admin/product/editProductServiceView/${tableName }/${l.id}">Edit</a>
                                    <a href="#"
                ...
                <div class="row warningmodel main-card">
                    <div class="col s8 m6 l6 offset-l4">
                        ...
                        <c:if test="${not empty imagepath }">
                            ...
                            <div class="card-content">
                                <p>There is no ${ tableName eq 'services' ? 'Gate Management System' : tableName}.Please
                                    click upload button to upload.</p>
                            </div>

    ...
    <form action="${digify}/admin/product/insertProduct?${_csrf.parameterName}=${_csrf.token}" method="post"
        ...
        <div class="row section">
            ...
            <div class="col s8 m4 l7">
                <input type="file" id="input_file" name="file" class="dropify" data-height="150"
        ...
        <div class="row section">
            ...
            <div class="input-field col s8 m4 l4">
                <input id="cost" type="text" class="validate" autocomplete="off"
        ...
        <div class="row section">
            ...
            <div class="input-field col s8 m4 l7">
                <input id="${productService}name" type="text" class="materialize-textarea" maxlength="250"
                       autocomplete="off"
                       name="${productService}Name"></input> <label for="${productService}name"
                                                                    class="">${productService} Name</label>
            </div>
        </div>
        <div class="row section">
            <div class="col s12 m4 l3">

...
<div class="container">
    ...
    <form
        ...
        <div class="row section">
            ...
            <input name="oldImageURL" type="hidden"
                   value="${tableName eq 'products' ? obj.productImage : obj.serviceImage }">
        </div>
        ...
        <div class="row section">
            ...
            <div class="input-field col s8 m4 l4">
                <input id="externalLink" type="text" class="validate" value="${obj.externalLink}"
                       onchange="checkImageLink(this)"
                       autocomplete="off" name="externalLink" maxlength="250"> <label for="email" class="">Image
                External Link</label>
            </div>
        </div>
        <!-----------------------for ecommerce part------------------------------------------  -->
        <div class="row section">
            <div class="col s12 m4 l3">
                <p>Is Available For Sale</p>
            </div>

            <div class="input-field col s8 m4 l4">
                <select class="input-field" name="isForEcommerce" id="isForEcommerce">
                    <option value="0" ${obj.isForEcommerce eq 0 ? 'selected' : '' }>No</option>
                    <option value="1" ${obj.isForEcommerce eq 1 ? 'selected' : '' }>Yes</option>
                </select>
            </div>
        </div>
        ...
        <div class="row section">
            <div class="col s12 m4 l3">
                <p>${productService} Cost</p>
            </div>

            <div class="input-field col s8 m4 l4">
                <input id="cost" type="text" class="validate" autocomplete="off" value="${obj.cost}"
                       name="cost"></input> <label for="cost" class="">${productService} cost</label>
            </div>
        </div>
        <!-- ------------------------------------------------------------------------------------------------------ -->
        <div class="row section">
            ...
            <div class="input-field col s8 m4 l7">
                <input id="${productService}name" type="text" class="materialize-textarea" maxlength="250"
                       autocomplete="off"
                       value="${tableName eq 'products' ? obj.productName : obj.serviceName}"
                       name="${productService}Name"></input> <label for="${productService}name" class="">${gms}
                Name</label>
            </div>
        </div>
        <div class="row section">

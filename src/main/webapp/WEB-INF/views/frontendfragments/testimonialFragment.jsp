                ...
                <c:forEach begin="0" end="9" var="prod" varStatus="status">
                    <div class="item">
                        <figure class="snip1192">
                            <blockquote>The company's experts have accumulated valuable experience in green development,
                                being savvy to all aspects of the certification process and requirements.
                            </blockquote>
                            <div class="author">

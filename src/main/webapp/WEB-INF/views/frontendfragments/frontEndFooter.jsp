    ...
    <div class="container-fluid p-0">
        <div id="cshero-footer" class="cshero-footer1">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="cshero-footer-feature-inner clearfix">
                                <div class="feature-top-item">
                                    <div class="media">
                                        <div class="media-left">
                                            <span class="lnr lnr-map"><img class="footerimg"
                                                                           src="${digify}/static/frontEnd/img/visit.png"/></span>
                                        </div>
                                ...
                                <div class="feature-top-item">
                                    <div class="media">
                                        <div class="media-left">
                                            <span class="lnr lnr-envelope"><img class="footerimg"
                                                                                src="${digify}/static/frontEnd/img/email.png"/></span>
                                        </div>
                                        <div class="media-body">
                                            <b><span>Email Us</span></b> <a
                                                style="color: #828282; text-decoration: none;"
                                                href="mailto:info@digify.net.in">info@digify.net.in</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="feature-top-item">
                                    <div class="media">
                                        <div class="media-left">
                                            <span class="lnr lnr-phone"><img class="footerimg"
                                                                             src="${digify}/static/frontEnd/img/call_0.png"/></span>
                                        </div>
                                        <div class="media-body">
                                            <b><span>Call Us</span></b> <a
                                                style="color: #828282; text-decoration: none;" href="tel:0124-6512448">0124-4014785,
                                            9599662884</a>
                                        </div>
                                ...
                                <div class="textwidget">
                                    <div class="media">
                                        <div class="media-left">
                                            ...
                                            <div class="media-body">Digify Engineering Pvt. Ltd. maintains an optimal
                                                security which is an integral part of any business that not only
                                                protects your employees but your assets as well..
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <aside id="nav_menu-2" class="widget widget_nav_menu">
                                ...
                                <div class="menu-navigation-container">
                                    <ul id="menu-navigation" class="menu p-0">
                                        <li id="menu-item-121"
                                            class="menu-item menu-item-type-custom menu-item-object-custom no_group menu-item-121"
                                            data-depth="0">
                                            <a href="${digify }/home/aboutUs" class=""><span
                                                    class="menu-title">About Us</span></a>
                                        </li>
                                        <li id="menu-item-122"
                                            class="menu-item menu-item-type-custom menu-item-object-custom no_group menu-item-122"
                                            data-depth="0">
                                            <a href="${digify }/home/dashBoard/products" class=""><span
                                        ...
                                        <li id="menu-item-126"
                                            class="menu-item menu-item-type-custom menu-item-object-custom no_group menu-item-126"
                                            data-depth="0">
                                        ...
                                        <c:forEach items="${allServices }" var="services" varStatus="loop">
                                            <c:if test="${loop.count < 6 }">
                                                <li id="menu-item-${loop.count}"
                                                    class="menu-item menu-item-type-custom menu-item-object-custom no_group menu-item-503">
                                                    <a
                                                            class="servicemenulink"
                                                            href="${digify}/home/servicePage/${services.id}"><span
            ...
            <div id="cs-copyright">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 textalign-centre">Copyright � DIGIFY
                            Engineering Pvt. Ltd.

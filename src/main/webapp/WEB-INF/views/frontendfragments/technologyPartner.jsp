...
<!-- 		<h3 class="serviceheading">They Always Trust Us</h3> -->
          <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12"><span class="ourstorydiv1">Our Technology Partners</span>
          </div>
        </div>
			<div class="col-lg-12">
				<div class="owl-carousel our-client">
				<div><img class="client_img" src="${digify}/static/frontEnd/img/tp/ahuja.png" class="attachment-medium size-medium wp-post-image" alt=""></div>
				<div><img class="client_img" src="${digify}/static/frontEnd/img/tp/cisco.png" class="attachment-medium size-medium wp-post-image" alt=""></div>
				<div><img class="client_img" src="${digify}/static/frontEnd/img/tp/dlink.png" class="attachment-medium size-medium wp-post-image" alt=""></div>
				<div><img class="client_img" src="${digify}/static/frontEnd/img/tp/gunnebo.png" class="attachment-medium size-medium wp-post-image" alt=""></div>

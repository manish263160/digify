 ...
 */
@Component("digifyAuthenticationProvider")
public class DigifyAuthenticationProvider implements AuthenticationProvider {

    private static final Logger logger = Logger.getLogger(DigifyAuthenticationProvider.class);
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        try {
            ...
            User user = userService.getUserByUserName(email, password);
            if (user == null) {
